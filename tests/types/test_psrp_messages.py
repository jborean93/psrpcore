...
import datetime
import psrpcore.types._psrp_messages as psrp_messages
...
def test_session_capability_with_timezone():
    ps_value = psrp_messages.SessionCapability("1.2", "1.2.3", TimeZone=b"\x00\x01\x02\x03", SerializationVersion="4.5")
    assert ps_value.PSVersion == PSVersion("1.2")
    assert ps_value.protocolversion == PSVersion("1.2.3")
